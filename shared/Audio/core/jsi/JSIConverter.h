...
public:
     ...
     * @param jsConfig Objet JavaScript contenant la configuration (sampleRate, bufferSizeFrames, channelCount, etc.)
     ...
     * @return Objet JavaScript représentant la configuration avec tous les champs
     */
