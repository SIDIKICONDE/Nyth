...
// Paramètres audio par défaut - Utilise les constantes globales
static constexpr uint32_t DEFAULT_SAMPLE_RATE = GlobalAudioConstants::DEFAULT_SAMPLE_RATE; // Default sample rate
static constexpr bool DEFAULT_ENABLED = true; // Default enabled state
...
// Constantes FFT et fenêtrage étendues
