...
public:
    ...
    float getProcessingTimeUs() const { return processingTimeUs_.load(); }
...
public:
    ...
    static void convertCaptureToEffectsFormat(const float* captureData, 
                                              float* effectsData, 
                                              size_t frameCount, 
                                              int channels);
    
    // Synchronisation entre modules
    static void syncModuleTiming(AudioCapture* capture, 
                                 AudioEffectsChain* effects);
    
    // Validation de compatibilité
    static bool areModulesCompatible(const AudioCaptureConfig& captureConfig,
