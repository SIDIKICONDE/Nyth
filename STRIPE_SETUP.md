...
Stripe n'est plus utilisé dans cette application. Ce document est conservé uniquement pour historique et ne doit plus être suivi.
...
- Paiements via Stripe: désactivés
- Cloud Functions Stripe: supprimées
- UI liée à Stripe: neutralisée

---

Ancien contenu (obsolète):

## 🔑 Configuration des clés API (obsolète)
