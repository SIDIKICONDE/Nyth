 ...
 */
export const useAudioDebounce = <T extends (...args: never[]) => unknown>(
  callback: T,
  delay: number = 50
): T => {
 ...
 */
export const useAudioThrottle = <T extends (...args: never[]) => unknown>(
  callback: T,
 ...
 */
export const useAudioMemo = <T, D extends readonly unknown[]>(
  factory: () => T,
  deps: D,
