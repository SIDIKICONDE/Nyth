...
export class MessageTemplateEngine {
  ...
  private initializeTemplates() {
    ...
    this.addTemplate({
      ...
      templates: [
        {
          title: "Bienvenue sur CamPrompt AI ! 🎉",
          message:
        ...
        },
        {
          title: "C'est parti ! ✨",
          message:
            "Salut {name} ! Découvrez comment CamPrompt AI peut révolutionner votre création de contenu. Commençons par votre premier script !",
          emoji: "🎬",
        },
        {
          title: "Votre voyage créatif commence 🌟",
          message:
            "Bienvenue {name} ! Avec CamPrompt AI, créer des scripts professionnels n'a jamais été aussi simple. Explorons ensemble !",
          emoji: "📝",
        },
      ],
      conditions: [
