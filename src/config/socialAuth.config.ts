/**
 * Configuration pour les authentifications sociales
 * Google Sign-In et Apple Sign-In
 *
 * SÉCURITÉ: Les clés API sont importées depuis les variables d'environnement
 * NE JAMAIS mettre les clés en dur dans le code source !
 */
