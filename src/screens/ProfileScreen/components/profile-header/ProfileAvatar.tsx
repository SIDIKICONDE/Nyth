...
const AvatarEditButton: React.FC<{
  ...
  <View
    style={[
      tw`absolute bottom-0 right-0 w-9 h-9 rounded-full items-center justify-center border-2`,
      {
  ...
  >
    <MaterialCommunityIcons name="camera-plus" size={18} color={iconColor} />
  </View>
);
...
export const ProfileAvatar: React.FC<ProfileAvatarProps> = ({
  ...
  <View style={tw`flex-1 items-center justify-center mt-8`}>
    <TouchableOpacity
      ...
      style={[
        tw`w-24 h-24 rounded-full border-4 relative`,
        {
