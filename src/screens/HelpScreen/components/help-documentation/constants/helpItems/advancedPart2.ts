    ...
    content: [
      {
        type: "text",
        content:
          "L'écran d'enregistrement de CamPrompt AI combine enregistrement vidéo professionnel et téléprompteur intelligent avec plus de 25 fonctionnalités avancées.",
      },
      {
        type: "list",
    ...
    content: [
      {
        type: "text",
        content:
          "L'écran Paramètres IA de CamPrompt AI centralise toute la configuration des providers d'intelligence artificielle, la gestion des clés API, la sécurité biométrique et l'ordre de priorité pour une expérience IA optimisée.",
      },
      {
        type: "list",
        ...
        content: [
          ...
          "🔒 Protection biométrique (Face ID/Touch ID) avancée",
