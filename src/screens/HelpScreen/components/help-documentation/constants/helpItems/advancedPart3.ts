    ...
    content: [
      {
        type: "text",
        content:
          "Le Générateur IA de CamPrompt AI crée automatiquement des scripts personnalisés selon vos besoins. Il combine intelligence artificielle avancée, suggestions contextuelles et paramètres précis pour générer du contenu optimisé.",
      },
      {
        type: "list",
    ...
    content: [
      {
        type: "text",
        content:
          "CamPrompt AI vous offre maintenant un contrôle précis sur la longueur de vos scripts générés avec trois types de paramètres : mots, caractères et paragraphes. Ces contrôles fonctionnent avec un système de priorité intelligent.",
      },
      {
        type: "list",
