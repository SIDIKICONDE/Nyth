    ...
    content: [
      {
        type: "text",
        content:
          "CamPrompt AI intègre plusieurs modèles d'IA pour vous assister dans la création de contenu.",
      },
      {
        type: "list",
    ...
    content: [
      {
        type: "text",
        content:
          "CamPrompt AI offre des contrôles avancés pour optimiser la qualité de vos enregistrements.",
      },
      {
        type: "list",
    ...
    content: [
      {
        type: "text",
        content:
          "La mémoire IA de CamPrompt AI analyse intelligemment vos conversations pour se souvenir de vos préférences, habitudes et besoins. Cette fonctionnalité révolutionnaire permet à l'IA d'offrir des suggestions toujours plus pertinentes.",
      },
      {
        type: "list",
