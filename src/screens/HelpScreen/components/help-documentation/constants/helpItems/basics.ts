...
export const basicsItems: HelpItem[] = [
  {
    id: "first-steps",
    title: "Premiers pas avec CamPrompt AI",
    ...
    content: [
      {
        type: "text",
        content:
          "Bienvenue dans CamPrompt AI ! Cette application transforme votre appareil en un téléprompteur professionnel avec intelligence artificielle intégrée.",
      },
      {
        type: "steps",
    ...
    content: [
      {
        type: "text",
        content:
          "L'éditeur de CamPrompt AI offre une expérience d'écriture professionnelle avec interface adaptative, outils IA intégrés et statistiques en temps réel.",
      },
      {
        type: "steps",
    ...
    content: [
      {
        type: "text",
        content:
          "L'enregistrement vidéo avec téléprompteur est la fonctionnalité principale de CamPrompt AI.",
      },
      {
        type: "steps",
