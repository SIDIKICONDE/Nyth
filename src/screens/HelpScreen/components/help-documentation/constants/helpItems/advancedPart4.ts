    ...
    content: [
      {
        type: "text",
        content:
          "Le chat IA de CamPrompt AI est votre assistant intelligent polyvalent pour créer, améliorer et discuter de vos scripts. Il combine conversation libre et actions spécialisées dans une interface riche et personnalisable.",
      },
      {
        type: "list",
