...
export const QuickHelpSection: React.FC = () => {
  ...
  const faqItems: FAQItem[] = [
    // Général
    {
      id: "what-is-camprompt",
      question: "Qu'est-ce que CamPrompt AI ?",
      answer:
        "CamPrompt AI est une application de téléprompteur intelligent qui combine enregistrement vidéo et intelligence artificielle. Elle vous aide à créer des scripts, les lire naturellement et enregistrer des vidéos professionnelles.",
      category: "general",
      icon: "information",
      color: "#3B82F6",
    },
    {
      ...
      answer:
        "CamPrompt AI est actuellement en phase de test. Toutes les fonctionnalités sont disponibles gratuitement : éditeur de scripts, téléprompteur intelligent, enregistrement vidéo haute qualité, IA intégrée, thèmes personnalisés et synchronisation cloud.",
      category: "general",
      icon: "star",
      color: "#3B82F6",
    },
    ...
    // Phase de test
    {
      ...
      answer:
        "Oui ! CamPrompt AI est actuellement en phase de test bêta. Toutes les fonctionnalités sont gratuites pendant cette période. Profitez-en pour explorer toutes les possibilités de l'application.",
      category: "billing",
      icon: "gift",
      color: "#F59E0B",
    },
  ...
  const quickActions: QuickAction[] = [
    ...
    },
    {
      ...
      icon: "account-group",
      color: "#8B5CF6",
      action: () => Linking.openURL("https://discord.gg/camprompt-ai"),
    },
  ];
        ...
        >
          ...
          <View style={tw`flex-1`}>
            ...
            <Text style={[tw`text-xs`, { color: "#92400E" }]}>
              Contactez notre support : support@camprompt-ai.com
            </Text>
          </View>
        </View>
      </Animated.View>
