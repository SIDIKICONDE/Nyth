...
export const AISettingsGuideSection: React.FC = () => {
  ...
  const aiSettingsGuides: AISettingsGuideItem[] = [
      ...
      content: [
        {
          type: "text",
          content:
            "Les paramètres IA de CamPrompt AI centralisent toute la configuration de l'intelligence artificielle : providers, clés API, sécurité biométrique, ordre de priorité et mémoire IA. C'est votre centre de contrôle pour une expérience IA optimale.",
        },
        {
          type: "list",
      ...
      content: [
        {
          type: "text",
          content:
            "CamPrompt AI supporte 5 providers d'intelligence artificielle, chacun avec ses spécialités. 4 offrent des quotas gratuits généreux, et OpenAI propose une qualité premium payante.",
        },
        {
          type: "list",
        ...
        },
        {
          type: "warning",
          content:
            "Ne partagez JAMAIS vos clés API ! Chaque clé est personnelle et liée à votre compte. Activez la protection biométrique pour plus de sécurité.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      description: "Sécurisez vos clés API avec Face ID/Touch ID",
      icon: "fingerprint",
      color: "#8B5CF6",
      content: [
        {
          type: "text",
          content:
            "La protection biométrique ajoute une couche de sécurité supplémentaire en exigeant votre empreinte digitale ou reconnaissance faciale pour accéder aux clés API et paramètres sensibles.",
        },
        {
          type: "list",
          title: "🔒 Fonctionnalités de sécurité :",
          content: [
            "Protection globale avec toggle principal",
            "Protection spécifique des clés API",
            "Protection des modifications de paramètres",
            "Session temporaire de 5 minutes",
            "Support natif Face ID et Touch ID",
            "Données biométriques jamais partagées",
          ],
        },
        {
          type: "steps",
          title: "Activer la protection biométrique :",
          content: [
            "Configurez au moins une clé API (prérequis)",
            "Vérifiez que Face ID/Touch ID est activé sur l'appareil",
            "Activez le toggle 'Protection biométrique'",
            "Authentifiez-vous pour confirmer",
            "Choisissez les éléments à protéger",
            "La protection est maintenant active",
          ],
        },
        {
          type: "list",
          title: "⚡ Comportement de la protection :",
          content: [
            "Accès aux clés : Authentification requise",
            "Modification paramètres : Vérification biométrique",
            "Session de 5 min : Pas de ré-authentification",
            "Échec biométrique : Retour à l'écran précédent",
            "Désactivation : Authentification nécessaire",
          ],
        },
        {
          type: "warning",
          content:
            "La protection biométrique nécessite au moins une clé API configurée et un capteur biométrique fonctionnel sur votre appareil.",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            "Activez la protection biométrique",
