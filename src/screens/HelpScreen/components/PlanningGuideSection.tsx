      ...
      content: [
        {
          type: "text",
          content:
            "La planification dans Nyth vous aide à organiser vos projets vidéo, gérer vos objectifs créatifs et suivre votre progression. C'est votre centre de contrôle pour une création de contenu structurée et efficace.",
        },
        {
          type: "steps",
