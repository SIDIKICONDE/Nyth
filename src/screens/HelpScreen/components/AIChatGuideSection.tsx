      ...
      content: [
        {
          type: "text",
          content:
            "L'AI Chat de Nyth est votre assistant intelligent personnel pour créer, améliorer et discuter de vos scripts. Il combine conversation naturelle, actions spécialisées et mémoire intelligente pour une expérience personnalisée.",
        },
        {
          type: "steps",
      ...
      content: [
        {
          type: "text",
          content:
            "Nyth supporte 5 providers IA différents pour vous offrir flexibilité et redondance. Chaque provider a ses spécialités et quotas.",
        },
        {
          type: "list",
