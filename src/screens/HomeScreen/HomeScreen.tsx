...
import { CacheInfo, ContentTabs, HomeHeader } from "./components";
...
export default function HomeScreen() {
  ...
  // Données des scripts et enregistrements (déplacé plus haut pour le hook)
  const {
    scripts,
    recordings,
    deleteScript,
  ...
  // Les messages de bienvenue intelligents sont maintenant gérés par UnifiedHomeFAB

  // Les annonces sont maintenant intégrées dans le système intelligent

  logger.debug(
    "🏠 HomeScreen - scriptDisplayStyle:",
    scriptDisplayStyle,
    "isLoaded:",
    displayPrefsLoaded
  );
