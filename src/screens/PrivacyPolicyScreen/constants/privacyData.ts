...
export const createPrivacyData = (
...
): PrivacySection[] => [
  {
    ...
    title: "À propos",
    content:
      "CamPrompt AI (« l'Application ») est éditée par CamPrompt AI, 221 route de Schirmeck, 67200 Strasbourg, France. Cette politique décrit comment sont collectées, utilisées, stockées et protégées les informations des utilisateurs lors de l'utilisation de l'Application native sur iOS et Android.",
  },
  {
    icon: "database",
  ...
  },
  {
    ...
    content:
      "En tant qu'application mobile native, CamPrompt AI n'utilise pas de cookies web. Des identifiants d'appareil anonymes peuvent être générés pour les statistiques d'usage (désactivables dans Paramètres > Confidentialité). Aucun tracking publicitaire n'est effectué.",
  },
  {
    icon: "update",
    title: "Modifications",
