...
export const useUnifiedPermissions = () => {
  ...
  // Fonction principale pour demander les permissions avec cache
  const requestPermissions = async (): Promise<boolean> => {
    try {
      // Utiliser le FileManager qui intègre le cache des permissions
      const { FileManager } = await import("@/services/social-share/utils/fileManager");
